...
# Move the generated PDF to the script directory (tugas-KLM)
echo "Moving $BUILD_DIR/$PDF_FILE to $SCRIPT_DIR/$PDF_FILE..."
mv "$BUILD_DIR/$PDF_FILE" "$SCRIPT_DIR/$PDF_FILE"
...
echo "KLM project build complete. PDF moved to $SCRIPT_DIR."